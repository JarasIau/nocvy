...
def return_args():
    parser = argparse.ArgumentParser(description="noczwy-mt - enumerarte website's directories and write to standard output", epilog="This software is licensed under the BSD-3-Clause license.")
